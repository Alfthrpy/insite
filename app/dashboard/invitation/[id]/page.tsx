        ...
        <div className="container w-full sm:w-3/5 m-4 p-5 rounded-box bg-white">
           <div className="flex w-full flex-col mt-4 gap-3">
              ...
              <div className="flex flex-wrap lg:flex-row gap-6 p-3">
                 <a className="btn no-animation bg-purpleHover hover:bg-purpleSecondary rounded-md flex flex-col gap-2 h-36 w-40 flex-grow place-items-center min-w-[150px]" href="/dashboard/invitation/1/bride-broom">
                    <img src="../../img/fiturLightMode/fitur1.png" alt="" className="w-8" />
                    <p className="text-base-100">Nama Pengantin</p>
                 </a>
