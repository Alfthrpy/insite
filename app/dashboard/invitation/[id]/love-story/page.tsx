    ...
    <div className=" w-full xl:w-4/5 m-4 min-h-screen">
      <div className="flex justify-center w-full">
        <div className="bg-white rounded-lg shadow-lg p-6 pb-9 w-full">
          <h1 className="text-center text-3xl font-bold mb-4 h-14 mt-5">Love Story</h1>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <div className="flex flex-col items-center justify-center lg:justify-start order-1 lg:order-none">
                  <div className="flex flex-col items-center">
                    ...
                    />
                    <div className="btn mt-2 bg-purpleHover hover:bg-purple text-base-100">Upload Image</div>
                  </div>
                </div>
                <div className="col-span-1 order-2 lg:order-none">
                  ...
                  <div className="mt-4">
                    Kisah Cinta
                    <textarea placeholder="Kisah cinta" className="textarea textarea-bordered textarea-lg w-full h-full"></textarea>
                  </div>
                </div>
              </div>
          ...
          <div className="btn bg-base-200 flex self-center my-5 text-xl">tambahkan cerita</div>
          <div className="btn bg-black text-base-100 flex justify-self-center mt-7 text-xl">simpan</div>
      <h1>Love Story Data </h1>
      {data ? (
          <div>
