      ...
      <div className="container p-5 rounded-box bg-white">
        <div className="flex flex-wrap lg:flex-row gap-6 p-3 justify-center xl:justify-between">
          <div className="card rounded-md h-full xl:grow w-96 gap-3">
            <p className="font-bold text-3xl mb-10">Selamat Datang di <br /> Dashboard Insite</p>
            ...
            <div className="border-2 border-purpleHover rounded-md flex h-20 items-center justify-between px-4">
              <div className="flex items-center">
                ...
                <div className="flex flex-col items-start gap-1 ml-2">
                  <h1 className="text-xl font-bold text-neutral m-0 leading-none pr-2">A & B</h1>
                  <h1 className="text-sm text-neutral m-0 leading-none">-</h1>
                </div>
              </div>
              <div className="btn bg-purpleHover hover:bg-purpleSecondary ml-auto items-center justify-start">
              <img src="./img/fiturLightMode/web.png" alt="wedding" className="w-6"/>
                <div className="flex flex-col items-start gap-1">
                  <h1 className="text-md text-base-100 m-0 leading-none">Lihat web</h1>
                </div>
              </div>
            </div>
          <div className="flex flex-nowrap justify-between gap-3">
              <div className="btn no-animation bg-neutral rounded-md flex h-16 items-center justify-start px-4 flex-1 grow">
                <img src="./img/fiturLightMode/settings.png" alt="wedding" className="w-8"/>
                <div className="flex flex-col items-start gap-1 ml-2">
                  <h1 className="text-xl font-bold text-base-100 m-0 leading-none">Kelola</h1>
                </div>
              </div>
            <div className="btn no-animation bg-neutral rounded-md flex h-16 items-center justify-start px-4 flex-1 grow">
              <img src="./img/fiturLightMode/send.png" alt="wedding" className="w-8"/>
              <div className="flex flex-col items-start gap-1 ml-2">
                <h1 className="text-xl font-bold text-base-100 m-0 leading-none">Bagikan</h1>
              </div>
            </div>
          </div>
          </div>
          ...
          <div className="carousel carousel-vertical rounded-box h-96 place-items-center">
              <div className="carousel-item h-[500px] w-auto rounded-box">
                <img src="../img/template/prewed1.png" className="w-full h-full object-cover"/>
              </div>
        ...
        <div className="flex w-full flex-col mt-4 gap-5">
          <div className="btn no-animation bg-purpleHover hover:bg-purpleSecondary rounded-md flex h-20 items-center justify-start px-4 flex-nowrap">
            <img src="./img/fiturLightMode/wedding-invitation.png" alt="wedding" />
            <div className="flex flex-col items-start gap-1 ml-2">
              <h1 className="text-xl font-bold text-base-100 m-0 leading-tight">Buat Undangan Baru (Belum Tersedia)</h1>
              <h1 className="text-sm text-base-100 m-0 leading-tight">Buat Undangan Baru</h1>
            </div>
          </div>
          <div className="btn no-animation bg-neutral rounded-md flex h-20 place-items-center justify-start px-4 flex-nowrap">
            ...
            <div className="flex flex-col items-start gap-1 ml-2">  
              <h1 className="text-xl font-bold text-base-100 m-0 leading-none">Buka Scanner QR Code</h1>
              <h1 className="text-sm text-base-100 m-0 leading-none">Scan undangan tamu</h1>
            </div></div>
        </div>
