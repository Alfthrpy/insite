        ...
        <div className="drawer lg:drawer-open">
          ...
          <div className="drawer-side z-50 lg:z-30">
            ...
            className="drawer-overlay "
                 ></label>
                  <ul className="menu bg-purpleNeutral text-base-100 min-h-full w-48 p-4 flex flex-col justify-center gap-4">
                    <Image
                       src="/img/logo.png"
                       alt="logo"
                       width={50}
                     ...
                     <li
                        className={`${
                           location.pathname === "/dashboard" ? "bg-purpleDrawer rounded-md" : ""
                        }`}
                     >
                     ...
                     <li
                        className={`${
                           location.pathname === "/dashboard/customer-service" ? "bg-purpleDrawer rounded-md" : ""
                        }`}
                     >
                        <a href="/dashboard/customer-service">Customer <br /> Service</a>
                     </li>           
                  </ul>
               </div>
           </div>
